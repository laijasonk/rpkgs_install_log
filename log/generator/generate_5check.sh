...
output_html="${log_dir}/5check.html"
...
cat "${log_dir}/base/5check_top.html" >> "${output_html}"
cat "${log_dir}/base/sidebar.html" >> "${output_html}"
cat "${log_dir}/base/5check_content.html" >> "${output_html}"
echo "${html}" >> "${output_html}"
cat "${log_dir}/base/5check_bottom.html" >> "${output_html}"
