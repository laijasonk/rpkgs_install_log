...
output_html="${log_dir}/4install.html"
...
do
    list_html="${list_html}
        ...
        log_html="${log_html}
            ...
            <iframe class=\"log text-above\" src=\"./raw/install_${pkg_name}.txt\" style=\"height: 200px; margin-bottom: 5em;\"></iframe>
...
cat "${log_dir}/base/4install_top.html" >> "${output_html}"
cat "${log_dir}/base/sidebar.html" >> "${output_html}"
cat "${log_dir}/base/4install_content.html" >> "${output_html}"
echo "${html}" >> "${output_html}"
cat "${log_dir}/base/4install_bottom.html" >> "${output_html}"
