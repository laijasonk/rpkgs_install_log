...
# Default paths
output_html="${html_dir}/pages/check.html"
...
do
    list_html="${list_html}
        ...
        log_html="${log_html}
            ...
            <iframe class=\"log text-above bottom-space\" src=\"../log/check_${pkg_name}.txt\" style=\"height: 500px;\"></iframe>
...
cat "${html_template}/check_top.html" >> "${output_html}"
cat "${html_template}/sidebar.html" >> "${output_html}"
cat "${html_template}/check_content.html" >> "${output_html}"
echo "${html}" >> "${output_html}"
cat "${html_template}/check_bottom.html" >> "${output_html}"
